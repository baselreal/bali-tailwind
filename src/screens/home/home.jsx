...
export const Home = () => {
  return (
    <div className="h-screen w-full bg-cover bg-no-repeat " style={{ backgroundImage: `url(${Image})` }}>
      ...
      <div className="flex flex-col justify-center items-center text-center h-screen ">
        ...
        <div className="z-10">
        <div className="z-10  mt-4 pt-10 text-center justify-center items-center font-pacifico ">
        ...
        <div className="z-10 mb-14 mt-4 text-white ">Cheapest and Easier</div>
