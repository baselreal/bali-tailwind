...
export const About = () => {
  return (
    <section className="h-screen w-full bg-cover bg-center flex" style={{ backgroundImage: `url(${Bg1})` }}>
      ...
      <div className="z-10 lg:w-45 md:w-35 w-35 lg:ml-20 lg:mt-20 md:ml-20 md:mt-20 ml-5 mt-20">
        <Link to="/">
          <img className="" src={Back} alt="" />
        </Link>
      </div>
      <div className="flex flex-col justify-center text-center items-center w-screen h-full lg:-ml-20 md:-ml-20 -ml-10">
        <div className="z-10 font-pacifico lg:text-5xl md:text-4xl lg:mb-6 leading-[5.25rem]  text-[#FCB371]">About Us</div>
